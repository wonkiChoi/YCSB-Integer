...
public class CoreWorkload extends Workload {
  ...
  public boolean doInsert(DB db, Object threadstate) {
    ...
    do {
      ...
      status = db.insert(table, Integer.toString(keynum), values);
  ...
  public void doTransactionRead(DB db) {
    ...
    db.read(table, Long.toString(keynum), fields, cells);
  ...
  public void doTransactionReadModifyWrite(DB db) {
    ...
    db.update(table, Long.toString(keynum), values);
  ...
  public void doTransactionScan(DB db) {
   ...
   // db.scan(table, startkeyname, len, fields, new Vector<HashMap<String, ByteIterator>>());
    db.scan(table, Long.toString(keynum), len, fields, new Vector<HashMap<String, ByteIterator>>());
  }
...
//      db.insert(table, dbkey, values);
      db.insert(table, Long.toString(keynum), values);
    } finally {
